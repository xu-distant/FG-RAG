...
import articles_retrieve.src.index
import articles_retrieve.src.contriever
import articles_retrieve.src.util
import articles_retrieve.src.slurm
import articles_retrieve.src.data
from articles_retrieve.src.evaluation import calculate_matches
from articles_retrieve.src import normalize_text
    ...
    with torch.no_grad():
        ...
        for k, q in enumerate(queries):
            ...
            if len(batch_question) == args.per_gpu_batch_size or k == len(queries) - 1:
                ...
                output = model(**encoded_batch).to(device)
